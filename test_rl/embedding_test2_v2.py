...
import numpy as np
from env import ConstraintSimplificationEnv, ConstraintSimplificationEnv_v2
...
# 创建环境实例
# 创建环境实例
env = ConstraintSimplificationEnv_v2(attention_module, decoder, assertions, len(variables), len(variables))
observation, action_space = env.reset()
...
agent = PearlAgent(
    policy_learner=SoftActorCritic(
            ...
            actor_hidden_dims=[58, 128],
            critic_hidden_dims=[58, 128],
