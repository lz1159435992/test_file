...
from test_rl.test_script.utils import fetch_data_as_dict, find_assertions_related_to_var_name, \
...
#     print('failed', e)
#nju
dict_value = get_values_nju('/tmp/pycharm_project_20/test_rl/test_script/value_dictionary.db', 'value_dictionary')
