...
def solve(filepath,timeout):
    ...
    if result is None:
        ...
        #store dict_info
        result_list = preprocess_list(result_list)
        print(result_list)
        ...
        print('hint')
    elif 'starexec_description.txt' in file_path:
        print('NOTHING ')
if __name__ == '__main__':
    ...
    # test_path.append(directory)
    directory = '/home/nju/Downloads/smt/smt-comp/QF_FP'
    test_path.append(directory)
    ...
    for directory in test_path:
        ...
        for dirpath, dirnames, filenames in os.walk(directory):
            for filename in filenames:
                ...
                if 'starexec_description.txt' in file_path:
                    print('NOTHING ')
                else:
